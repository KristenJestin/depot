...
```json
{ "kind": "success", "payload": { "items": [ { "id", "name", "status", "createdAt", ... } ] } }
```

### `prd create`

```json
{ "kind": "success", "payload": { "item": { "id", "title", "status", "revision", ... } } }
```
...
### `prd commit` / `prd activate` / `prd amend`
...
```json
{ "kind": "success", "payload": { "item": { "id", "title", "status", "position", "effort", "dependsOn": [], ... } } }
```

`dependsOn` is a parsed string array, not a JSON string.
...
```json
{ "kind": "success", "payload": { "item": { "id", "eventType", "payload": { ... }, "createdAt", ... } } }
```
